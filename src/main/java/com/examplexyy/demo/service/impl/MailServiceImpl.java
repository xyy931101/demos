package com.examplexyy.demo.service.impl;
...
public class MailServiceImpl implements MailService {
    ...
    public String emailAccount = "18850198317@163.com";
    @Value("mail.send.password")
    public static String emailPassword = "xyy19931101";
    ...
    public void sendMail() throws MessagingException {
        ...
        props.setProperty("mail.smtp.port", protocol);
        props.setProperty("mail.smtp.socketFactory.fallback", "false");
        props.setProperty("mail.smtp.socketFactory.port", protocol);
