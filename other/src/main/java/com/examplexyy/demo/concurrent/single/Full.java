package com.examplexyy.demo.concurrent.single;
...
public class Full implements Serializable, Cloneable {
    ...
    public static void main(String[] args) throws IllegalAccessException, InstantiationException, CloneNotSupportedException, IOException, ClassNotFoundException {
        Class<?> aClass = Full.class.getClassLoader().loadClass("com.examplexyy.demo.concurrent.single.Full");
        Object o = aClass.newInstance();
        System.out.println(o);

        Class<?> aClass1 = Class.forName("com.examplexyy.demo.concurrent.single.Full");
